...
# (../atoms3_simple_robot/atoms3_simple_robot.ino)のPEER_MACとして使う
# ヘッダファイル(../atoms3_simple_robot/atoms3_simple_robot/pc_mac.h)を生成する。
#
...
OUT="$DIR/../atoms3_simple_robot/atoms3_simple_robot/pc_mac.h"
...
echo "[get_my_mac] ロボット側AtomS3(簡易版)の再コンパイルが必要です(../atoms3_simple_robot/flash.sh)。"
