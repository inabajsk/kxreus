...
public:
    ...
    ///
    /// This build is for kxrl6 (Kondo KXR-L6, an 18-DOF six-limbed body: 2
    /// legs + 2 arms + 2 mid-arms, each 3-DOF, all six standing on their
    /// tips) -- not the walking hand the rest of this mode's comments
    /// describe. No getup policy was
    /// trained for it, so this is the one-actor case: RISE and SIT (see
