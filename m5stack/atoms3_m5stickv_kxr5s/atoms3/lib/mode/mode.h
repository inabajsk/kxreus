...
/// with the same kxr5s firmware image running on any of five different
/// robots' own AtomS3, "which one is this" has to be answerable by looking
/// at the one screen the firmware has, not by tracing a USB cable, and it
/// can no longer be baked in at compile time the way a single-robot tree's
/// own ROBOT_NAME build flag was.
