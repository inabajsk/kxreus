...
// The M5StickV bridge's I2C transactions: a Wire instance of its own on
// G1/G2, a bus nothing else on this board touches (see rcb4_link.h's own
// comment on M5STICKV_SDA_PIN).
