...
// skipped, exactly the state a just-unboxed AtomS3 is in the first time
...
void setup() {
    ...
    // DISPLAY_ROTATION the way a per-robot tree had -- the same kxr5s image
    // can end up in any of the five robots' bodies. Set after
