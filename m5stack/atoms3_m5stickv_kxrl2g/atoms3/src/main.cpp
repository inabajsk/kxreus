...
// 0 for every robot except one whose ATOM sits mounted upside down on the
// body -- see this robot's own platformio.ini, which may override this to 2
// (180 degrees) if so mounted.
