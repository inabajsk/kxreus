# kxrl4d — M5StickC + M5StickV RCB-4 bridge
...
- `m5stickc/` — the RCB-4's COM adapter (PlatformIO/Arduino, ESP32). Relays
  ...
  opcode (0x91) through to the M5StickV. Runs kxrl4d's trained walk and
  getup policies in POLICY mode. See `m5stickc/platformio.ini` for the
  full board writeup.
