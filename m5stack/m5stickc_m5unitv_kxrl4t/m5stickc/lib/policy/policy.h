...
/// float32: that pair is noise next to the tens of thousands of
/// weights+biases below, and they feed the very first subtraction/
/// multiply every observation goes through, where a bad scale would
