...
public:
    ...
    ///
    /// This build is for kxrl4t (Kondo KXR-L4T, a 10-DOF quadruped-like
    /// biped: all four 2-DOF limbs stand on their tips) -- not the walking
    /// hand the rest of this mode's comments describe. No getup policy was
